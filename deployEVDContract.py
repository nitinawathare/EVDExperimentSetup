...
def deploySortContract(contract_source_path, w3, account):
    ...
    tx_hash = w3.eth.contract(
            ...
            bytecode=contract_interface1['bin']).constructor(35).transact({'txType':"0x2", 'from':account, 'gas':1607685})
    return tx_hash
...
def deployMatrixContract(contract_source_path, w3, account):
    ...
    tx_hash = w3.eth.contract(
            ...
            bytecode=contract_interface2['bin']).constructor(4).transact({'txType':"0x2", 'from':account, 'gas':1758781})
    return tx_hash
