...
This file compute the probability
of number of consecutive blocks 
an adversary will be able to mine
with increase in gas usage in comparison 
to ideal case with 0 block processing time.
