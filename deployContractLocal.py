...
tx_hash2 = w3.eth.contract(
        ...
        bytecode=contract_interface2['bin']).constructor(20).transact({'txType':"0x2", 'from':w3.eth.accounts[0], 'gas':8000000})
...
# while ((receipt3 is None) or (receipt2 is None) or (receipt1 is None)) and (w3.eth.blockNumber < 10) :
