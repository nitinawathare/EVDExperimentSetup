...
do
	...
	# ssh -n -i quorum2.key ubuntu@$REMOTE_SERVER "mkdir gitRepoEVD" 
 	#scp -i quorum2.key addressRead.py staticJsonRead.py passwords.txt installGo.sh downloadEVDCode.sh downloadEVDCode2.sh setupEthereum.sh ubuntu@$REMOTE_SERVER:/home/ubuntu/gitRepoEVD/&
	...
	ssh -n -i quorum2.key ubuntu@$REMOTE_SERVER "touch /home/ubuntu/gitRepoEVD/queuLengthStats" &
